...
qiime tools import \
  ...
  --output-path $2/pair-end-12s.qza

qiime demux summarize --i-data $2/pair-end-12s.qza \
  --o-visualization $2/pair-end-12s.qzv

qiime dada2 denoise-single \
  --p-n-threads 4 \
  --i-demultiplexed-seqs $2/pair-end-12s.qza \
  --p-trim-left $4 \
  --p-trunc-len $7 \
  --o-table $3/table.qza \
